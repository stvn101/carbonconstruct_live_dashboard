    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-green-950/20 to-black text-white p-4 font-sans selection:bg-primary selection:text-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="col-span-1 md:col-span-2 bg-white/5 backdrop-blur-xl border-white/10 shadow-2xl">
          <CardHeader><CardTitle>Carbon Savings Trend</CardTitle></CardHeader>
          <CardContent><VegaChart spec={trendSpec} className="w-full" /></CardContent>
        </Card>
        ...
        <Card className="col-span-1 md:col-span-2 bg-white/5 backdrop-blur-xl border-white/10 shadow-2xl">
          <CardHeader><CardTitle>Material Impact Breakdown</CardTitle></CardHeader>
          <CardContent><VegaChart spec={materialSpec} className="w-full" /></CardContent>
        </Card>
      </div>
    </div>
  );
